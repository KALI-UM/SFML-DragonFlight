...
bool P1_GameOver::Initialize()
{
	...
	m_GameOverRect =		new DRectangle({ 0,0 }, { 400, 600 }, sf::Color::Transparent, 1, sf::Color(50, 50, 50, 150), DrawType::UI);
...
void P1_GameOver::Reset()
{
	...
	m_GameOverText[1]->SetFillColor(sf::Color::White);
	m_GameOverText[2]->SetFillColor(sf::Color::White);
	m_GameOverText[0]->SetOutlineColor(sf::Color::Black);
	m_GameOverText[1]->SetOutlineColor(sf::Color::Black);
	m_GameOverText[2]->SetOutlineColor(sf::Color::Black);
	m_GameOverText[0]->SetOutlineThickness(2);
	m_GameOverText[1]->SetOutlineThickness(2);
	m_GameOverText[2]->SetOutlineThickness(2);
}
